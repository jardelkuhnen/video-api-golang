...
type Video struct {
	ID          uint64    `gorm:"primary_key;auto_increment" json:"id"`
	Title       string    `json:"title" binding:"min=2,max=10" validate:"is-bad-language" gorm:"type:varchar(100)"`
	Description string    `json:"description" binding:"max=100" gorm:"type:varchar(200)"`
